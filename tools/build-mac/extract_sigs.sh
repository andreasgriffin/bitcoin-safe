...
#
# This script is based on https://github.com/bitcoin/bitcoin/blob/194b9b8792d9b0798fdb570b79fa51f1d1f5ebaf/tools/macdeploy/detached-sig-create.sh
...
TEMPDIR="/tmp/bitcoin_safe_compare_dmg/sigs.temp"

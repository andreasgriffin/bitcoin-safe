...
if [[ "$(uname -m)" == "x86_64" ]]; then
    build_requirements_file="./tools/deterministic-build/requirements-build_mac_x86_64.txt"
fi
...
BITCOIN_SAFE_VERSION=$VERSION \
  pyinstaller --noconfirm --clean tools/build_mac/osx.spec || fail "PyInstaller failed."

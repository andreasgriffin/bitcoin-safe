...
#
# Usage:
#   tools/build_wine/verify_signed_executables.sh <unsigned-dir> <signed-dir> <variant> [<variant> ...]
#
...
# root like so:
#
#   tools/build_wine/verify_signed_executables.sh dist signpath-signed portable setup
#

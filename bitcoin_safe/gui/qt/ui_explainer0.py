...
class Ui_Form(object):
    ...
    def setupUi(self):
        ...
        add_centered([svg_widget], self.groupBox_3, self.verticalLayout_2, direction='h')
        ...
        svg_widget.setMinimumSize(qresize(svg_widget.sizeHint(), (60,80)))
        svg_widget.setMaximumSize(qresize(svg_widget.sizeHint(), (60,80)))
        add_centered([svg_widget], self.groupBox_4, self.verticalLayout_3, direction='h')
        ...
        svg_widget.setMinimumSize(qresize(svg_widget.sizeHint(), (60,80)))
        svg_widget.setMaximumSize(qresize(svg_widget.sizeHint(), (60,80)))
        add_centered([svg_widget], self.groupBox_5, self.verticalLayout_4, direction='h')
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"<html><head/><body><h1 align=\"center\" style=\" margin-top:18px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:xx-large; font-weight:600;\">Storing your bitcoin with</span></h1><h1 align=\"center\" style=\" margin-top:18px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:xx-large; font-weight:600;\">1 hardware wallet</span></h1></body></html>", None))
        self.groupBox_2.setTitle("")
        self.groupBox_3.setTitle(QCoreApplication.translate("Form", u"1)", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt;\">Buy 1 hardware wallet</span></p></body></html>", None))
        ...
        self.label_8.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt;\">Generate 24 secret words on your hardware wallet</span></p></body></html>", None))
        ...
        self.label_10.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt;\">Backup the 24 secret words on paper or steel in a secure location</span></p></body></html>", None))
        self.label_11.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt;\">Do not skip this step!</span></p><p><span style=\" font-size:12pt;\">Write the 24 secret words on paper or in steel.</span></p></body></html>", None))

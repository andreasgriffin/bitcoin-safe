...
from .util import open_website, create_buy_coldcard_button, create_buy_bitbox_button
...
class Ui_Form(QObject):
    ...
    def setupUi(self):
        ...
        add_centered(
            [svg_widget], self.groupBox_3, self.verticalLayout_2, direction="h"
        )
        ...
        svg_widget.setMaximumSize(qresize(svg_widget.sizeHint(), (60, 80)))
        add_centered(
            [svg_widget], self.groupBox_4, self.verticalLayout_3, direction="h"
        )
        ...
        svg_widget.setMaximumSize(qresize(svg_widget.sizeHint(), (60, 80)))
        add_centered(
            [svg_widget], self.groupBox_5, self.verticalLayout_4, direction="h"
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label_10.setText(
            QCoreApplication.translate(
                "Form",
                '<html><head/><body><p><span style=" font-size:12pt;">Backup the 24 secret words on paper or steel in a secure location</span></p></body></html>',
                None,
            )
        )
        self.label_11.setText(
            QCoreApplication.translate(
                "Form",
                '<html><head/><body><p><span style=" font-size:12pt;">Do not skip this step!</span></p></body></html>',
                None,
            )
        )

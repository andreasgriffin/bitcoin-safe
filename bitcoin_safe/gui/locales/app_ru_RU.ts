...
<TS version="2.1">
    ...
    &lt;/ul&gt;
			...
			<translation>Купить {number} аппаратных подписантов                              &lt;ul&gt;         {different_hint} 
        &lt;li&gt;Bitcoin Safe поддерживает всех основных аппаратных подписантов: &lt;a href="{url}"&gt;Посмотреть полный список&lt;/a&gt;&lt;/li&gt;     &lt;/ul&gt;
        </translation>
		</message>
	</context>
	<context>
...
{fee}, и {sent} отправлено!</translation>
	...
	<context>
		...
		<message>
			...
			<translation>Во время первой синхронизации Bitcoin Safe получает компактные сводки блоков от нескольких узлов Bitcoin. Это приватный способ загрузки данных блоков.</translation>
		</message>
		<name>InitialCbfSyncWidget</name>
		<message>
...
Location of signing device: .....</source>
			<translation>Название подписывающего устройства: ......
Местоположение подписывающего устройства: .....</translation>
		</message>
		<name>KeyStoreUI</name>
		<message>
...
If there is an issue, please dont hesitate to contact us at: andreasgriffin@proton.me</source>
			<translation>Завершите оплату в вашем браузере.
Если возникнут проблемы, пожалуйста, не стесняйтесь связаться с нами по адресу: [andreasgriffin@proton.me](mailto:andreasgriffin@proton.me)</translation>
		</message>
		<name>PaymentButton</name>
		<message>
		...
		<message>
			...
			<translation>Пожалуйста, выберите сумму пожертвования и валюту.</translation>
		</message>
		<name>PaymentButton</name>
		<message>
	...
	<context>
		...
		<message>
			...
			<translation>Получите &lt;b&gt;небольшую&lt;/b&gt; сумму (меньше {test_amount}) на 1 адрес этого кошелька.
                    &lt;br&gt;&lt;br&gt;                     &lt;b&gt;Почему?&lt;/b&gt; &lt;br&gt;                     Чтобы убедиться, что вы контролируете средства, необходимо протестировать отправку из кошелька. 
                    &lt;br&gt;                     Поэтому перед отправкой значительной суммы Bitcoin в кошелёк &lt;b&gt;крайне важно&lt;/b&gt; выполнить отправку и протестировать всех подписантов.                          &lt;br&gt;                     &lt;br&gt;                     &lt;b&gt;Пока НЕ отправляйте крупные суммы в кошелёк. Сначала завершите все тесты self-send!&lt;/b&gt;                    </translation>
		</message>
	</context>
	<context>
...
This practices the signing flow and ensures all hardware signers are setup correctly.</source>
	...
	<context>
		...
		<message>
			...
			<translation>Печать меток</translation>
		</message>
		<name>StickerTheHardware</name>
		<message>
...
'{next_text}'</source>
			<translation>Тестовая транзакция  '{tx_text}'  успешно выполнена. Пожалуйста, продолжите тест self-send: 

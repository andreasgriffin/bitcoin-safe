...
class Ui_MainWindow(QMainWindow):
    ...
    def init_menubar(self):
        ...
        self.menu_wallet.addAction(_("New Wallet"), self.new_wallet).setShortcut(
            QKeySequence("Ctrl+N")
        )
        self.menu_wallet.addAction("Open wallet", self.open_wallet).setShortcut(
            QKeySequence("Ctrl+O")
        )
        self.menu_wallet.addAction(
            "Save Current wallet", self.save_current_wallet
        ).setShortcut(QKeySequence("Ctrl+S"))
        self.menu_wallet.addAction("Find", self.toggle_search).setShortcut(
            QKeySequence("Ctrl+F")
        )
        ...
        self.menu_transaction.addAction(
            "Load Transaction from file", self.open_tx_file
        ...
        self.shortcut_close_tab.activated.connect(
            lambda: self.close_tab(self.tab_wallets.currentIndex())
        )
